...
public class EditSoftwareComponentHandler extends AbstractStructuredSelectionHandler {
	...
	protected void execute(Object element) throws ExecutionException {
		...
		GenericEditorInput<SoftwareComponent> input = new GenericEditorInput<SoftwareComponent>(lighthouseDomain, softwareComponent);
