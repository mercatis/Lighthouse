...
public class DeploymentConverter implements ILabelConverterHelper {

	public String getLabelForObject(Object obj) {
		Deployment deployment = (Deployment) obj;
		SoftwareComponent deployedComponent = deployment.getDeployedComponent();
		return LabelConverter.getLabel(deployedComponent) + " @ " + deployment.getLocation();
	}
}
