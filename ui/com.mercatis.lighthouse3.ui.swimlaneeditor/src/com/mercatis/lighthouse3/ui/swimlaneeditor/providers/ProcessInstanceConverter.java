...
public class ProcessInstanceConverter implements ILabelConverterHelper {

	private static SimpleDateFormat SDF = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

	public String getLabelForObject(Object obj) {
		if (obj == null || ((ProcessInstance)obj).getStartDate() == null)
			return "invalid instance";
		return SDF.format(((ProcessInstance)obj).getStartDate());
	}
}
