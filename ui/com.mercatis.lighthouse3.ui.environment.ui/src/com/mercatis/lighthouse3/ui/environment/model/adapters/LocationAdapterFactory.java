...
public class LocationAdapterFactory implements IAdapterFactory {
	...
	private LocationWorkbenchAdapter workbenchAdapter = new LocationWorkbenchAdapter();

	private LocationDropTargetAdapter dropTargetAdapter = new LocationDropTargetAdapter();
