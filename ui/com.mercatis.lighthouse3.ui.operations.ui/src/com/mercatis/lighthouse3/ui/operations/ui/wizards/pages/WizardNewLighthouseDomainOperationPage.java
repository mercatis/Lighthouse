...
public class WizardNewLighthouseDomainOperationPage extends AbstractWizardPage {
	...
	public void prefillProperty(Object key, Object value) {
		if (key != null && value != null) {
			if (key.equals("DOMAIN_OPERATION_URL")) {
	 ...
	 * @param pageName
	 */
	public WizardNewLighthouseDomainOperationPage() {
		super("Operations Page");
	}
	...
	public void createControl(Composite parent) {
		...
		urlGroup.setText("Operations URL");
		...
		urlText.setText(urlTextValue!=null ? urlTextValue : "http://localhost:8085");
		...
		testB.addSelectionListener(new SelectionListener() {
			public void widgetSelected(SelectionEvent e) {
				...
				try {
					...
					Pattern p = Pattern.compile("^<\\?xml version=\"[\\d\\.]+\"(?: \\w+=\"[\\w\\-]+\")*\\?>(?:<list>(?:<code>\\w+</code>)*</list>)?");
