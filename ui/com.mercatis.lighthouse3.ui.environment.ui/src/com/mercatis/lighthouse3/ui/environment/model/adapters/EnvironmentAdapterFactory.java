...
public class EnvironmentAdapterFactory implements IAdapterFactory {

	private EnvironmentWorkbenchAdapter workbenchAdapter = new EnvironmentWorkbenchAdapter();

	private EnvironmentDropTargetAdapter dropTargetAdapter = new EnvironmentDropTargetAdapter();
