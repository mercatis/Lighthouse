...
import com.mercatis.lighthouse3.ui.environment.editors.EnvironmentEditor;

public class EditEnvironmentHandler extends AbstractStructuredSelectionHandler {
	...
	protected void execute(Object element) throws ExecutionException {
		...
		GenericEditorInput<Environment> input = new GenericEditorInput<Environment>(lighthouseDomain, environment);
		IWorkbenchPage page = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage();
		try {
			IDE.openEditor(page, input, EnvironmentEditor.class.getName());
