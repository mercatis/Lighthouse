...
public class EnvironmentContainerContextAdapter implements ContextAdapter {

	/* (non-Javadoc)
	 * @see com.mercatis.lighthouse3.ui.security.ContextAdapter#toContext(java.lang.Object)
	 */
	public String toContext(Object entity) {
		EnvironmentContainer container = (EnvironmentContainer) entity;
		String domain = container.getLighthouseDomain().getServerDomainKey();
		
		return new StringBuilder("//LH3/").append(domain).append("/Environment").toString();
	}
	...
	public String toShortContext(Object entity) {
		return new StringBuilder("/Environment").toString();
	}
