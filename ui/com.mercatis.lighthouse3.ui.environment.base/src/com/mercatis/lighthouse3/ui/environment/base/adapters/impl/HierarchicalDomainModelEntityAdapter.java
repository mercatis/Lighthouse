...
public class HierarchicalDomainModelEntityAdapter extends DomainModelEntityAdapter {
	...
	public Object[] getChildren(Object adaptee) {
		return ((HierarchicalDomainModelEntity<?>) adaptee).getDirectSubEntities().toArray();
	}
	...
	public boolean hasChildren(Object adaptee) {
		boolean isComplexEntity = ((HierarchicalDomainModelEntity<?>) adaptee).isComplexEntity();
	...
	public Object getParent(Object adaptee) {
		return ((HierarchicalDomainModelEntity<?>) adaptee).getParentEntity();
	}
}
