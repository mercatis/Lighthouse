...
public interface DeploymentRegistryFactoryService extends RegistryFactoryService<DeploymentRegistry> {

	public DeploymentRegistry getRegistry(String lighthouseDomain);
	
	public DeploymentRegistry getRegistry(IProject project);
