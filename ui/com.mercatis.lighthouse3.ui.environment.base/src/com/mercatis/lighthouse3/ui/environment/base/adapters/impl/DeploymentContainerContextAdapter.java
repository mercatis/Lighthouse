...
public class DeploymentContainerContextAdapter implements ContextAdapter {

	/* (non-Javadoc)
	 * @see com.mercatis.lighthouse3.ui.security.ContextAdapter#toContext(java.lang.Object)
	 */
	public String toContext(Object entity) {
		DeploymentContainer container = (DeploymentContainer) entity;
		String domain = container.getLighthouseDomain().getServerDomainKey();
		
		return new StringBuilder("//LH3/").append(domain).append("/Deployment").toString();
	}
	...
	public String toShortContext(Object entity) {
		return new StringBuilder("/Deployment").toString();
	}
