...
public class DeploymentCarryingDomainModelEntityAdapter extends HierarchicalDomainModelEntityAdapter {
	...
	public boolean hasChildren(Object adaptee) {
		return super.hasChildren(adaptee) || ((DeploymentCarryingDomainModelEntity<?>) adaptee).hasDeployments();
	}
	 ...
	 * @return
	 */
	public Object[] getDeployments(Object adaptee) {
		return ((DeploymentCarryingDomainModelEntity<?>) adaptee).getDeployments().toArray();
	}
