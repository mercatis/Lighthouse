...
public class OperationInstallationLoaderConverter implements ILabelConverterHelper {

	public String getLabelForObject(Object obj) {
		if (obj instanceof OperationInstallationWrapper) {
			OperationInstallationWrapper loader = (OperationInstallationWrapper) obj;
			return loader.getOperation() == null ? LabelConverter.formatCode(loader.getOperationInstallation().getInstalledOperationCode())
					: LabelConverter.getLabel(loader.getOperation());
		}
		return null;
	}
}
