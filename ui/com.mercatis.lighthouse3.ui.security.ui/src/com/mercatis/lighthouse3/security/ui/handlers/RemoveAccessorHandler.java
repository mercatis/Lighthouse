...
public class RemoveAccessorHandler extends AbstractStructuredSelectionHandler {
	...
	protected void execute(Object element) throws ExecutionException {
		...
		if (formPage instanceof AbstractContextBasedPermissionEditorPage<?> && element instanceof AbstractAccessor) {
			((AbstractContextBasedPermissionEditorPage<?>)formPage).removeAccessor((AbstractAccessor)element);
		}
	}
}
