...
import com.mercatis.lighthouse3.status.ui.wizards.StatusNotificationEditor;
import com.mercatis.lighthouse3.ui.common.base.CommonBaseActivator;
import com.mercatis.lighthouse3.ui.environment.base.model.LighthouseDomain;
import com.mercatis.lighthouse3.ui.status.base.model.StatusEditingObject;


public class EditNotificationSettingsHandler extends AbstractStructuredSelectionHandler {
	...
	protected void execute(Object element) throws ExecutionException {
		if (element instanceof StatusEditingObject) {
			...
			StatusNotificationEditor wizard = new StatusNotificationEditor(lighthouseDomain, status);
			WizardDialog dialog = new WizardDialog(Display.getCurrent().getActiveShell(), wizard);
			dialog.create();
			dialog.getShell().setText("Status Notification Editor");
			dialog.setTitle("Edit status notification template on " + LabelConverter.getLabel(status));
			dialog.setMessage("Please provide information about the receiver and the email templates.");
