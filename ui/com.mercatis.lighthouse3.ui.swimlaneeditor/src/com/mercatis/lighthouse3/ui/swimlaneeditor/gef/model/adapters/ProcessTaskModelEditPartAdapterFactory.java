...
public class ProcessTaskModelEditPartAdapterFactory implements IAdapterFactory {

	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adapterType.equals(IPropertySource.class))
			return new ProcessTaskModelEditPartPropertySource((ProcessTaskModelEditPart) adaptableObject);
		return null;
	}
