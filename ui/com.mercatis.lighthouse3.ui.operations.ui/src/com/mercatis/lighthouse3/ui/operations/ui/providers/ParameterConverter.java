...
public class ParameterConverter implements ILabelConverterHelper {

	public String getLabelForObject(Object obj) {
		Parameter parameter = (Parameter) obj;
		String label = parameter.getName();
		if (parameter.getVariant() != null && label.startsWith(parameter.getVariant())) {
			label = label.substring(parameter.getVariant().length() + 2);
		}
		return label;
	}
}
