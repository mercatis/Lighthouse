...
public class ProcessInstanceDefinitionAdapterFactory implements IAdapterFactory {

	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adapterType.equals(IPropertySource.class))
			return new ProcessInstanceDefinitionPropertySource((ProcessInstanceDefinitionEditPart) adaptableObject);
		return null;
	}
