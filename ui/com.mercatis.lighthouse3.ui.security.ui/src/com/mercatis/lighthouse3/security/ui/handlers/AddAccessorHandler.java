...
public class AddAccessorHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (formPage instanceof AbstractContextBasedPermissionEditorPage<?>) {
			((AbstractContextBasedPermissionEditorPage<?>)formPage).addAccessor();
		}
		return null;
	}
	
	private IFormPage getActiveEditorFormPage() {
