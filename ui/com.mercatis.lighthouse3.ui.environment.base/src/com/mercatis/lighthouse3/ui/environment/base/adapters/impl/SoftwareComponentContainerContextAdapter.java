...
public class SoftwareComponentContainerContextAdapter implements ContextAdapter {

	/* (non-Javadoc)
	 * @see com.mercatis.lighthouse3.ui.security.ContextAdapter#toContext(java.lang.Object)
	 */
	public String toContext(Object entity) {
		SoftwareComponentContainer container = (SoftwareComponentContainer) entity;
		String domain = container.getLighthouseDomain().getServerDomainKey();
		
		return new StringBuilder("//LH3/").append(domain).append("/SoftwareComponent").toString();
	}
	...
	public String toShortContext(Object entity) {
		return new StringBuilder("/SoftwareComponent").toString();
	}
