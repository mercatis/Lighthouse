...
public interface ProcessInstanceDefinitionRegistry extends CodedDomainModelEntityDAO<ProcessInstanceDefinition> {

	public abstract ProcessInstanceDefinition findByProcessTask(ProcessTask processTask);
