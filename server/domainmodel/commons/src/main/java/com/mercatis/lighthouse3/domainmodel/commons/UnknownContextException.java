...
/**
 * This class captures exceptions with regard to incoming Events on unknown context entities
 */
public class UnknownContextException extends RuntimeException {
	...
	public UnknownContextException(String message, Exception cause) {
		super(message, cause);
	}
}