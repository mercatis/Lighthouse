...
public class EnvironmentWorkbenchAdapter implements IWorkbenchAdapter {
	...
	public String getLabel(Object adaptee) {
		Environment environment = (Environment) adaptee;
		return LabelConverter.getLabel(environment);
	}
