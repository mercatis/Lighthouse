...
public class LighthouseDomainContextAdapter implements ContextAdapter {

	/* (non-Javadoc)
	 * @see com.mercatis.lighthouse3.ui.security.ContextAdapter#toContext(java.lang.Object)
	 */
	public String toContext(Object entity) {
		LighthouseDomain domain = (LighthouseDomain) entity;
		
		StringBuilder builder = new StringBuilder("//LH3/").append(domain.getServerDomainKey());
