...
public class OperationInstallationConverter implements ILabelConverterHelper {

	public String getLabelForObject(Object obj) {
		return LabelConverter.formatCode(((OperationInstallation)obj).getInstalledOperationCode());
	}
}
