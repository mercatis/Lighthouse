...
public class SoftwareComponentWorkbenchAdapter implements IWorkbenchAdapter {
	...
	public String getLabel(Object adaptee) {
		SoftwareComponent component = (SoftwareComponent) adaptee;
		return LabelConverter.getLabel(component);
	}
	...
	public Object getParent(Object adaptee) {
		return ((HierarchicalEntityAdapter) Platform.getAdapterManager().getAdapter(adaptee, HierarchicalEntityAdapter.class)).getParent(adaptee);
	}
